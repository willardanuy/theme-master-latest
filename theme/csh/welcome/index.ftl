...
<head>
    ...
    <link rel="StyleSheet" href="welcome-content/keycloak-e82ff6ebac.css" type="text/css">
    <style>
        label {
...
<div class="wrapper">
    <div class="content">
        <div class="logo">
                <img src="welcome-content/keycloak_logo-3c1f794e93.png" alt="Keycloak" border="0" />
        </div>
        ...
        <p class="logos"><a href="http://www.jboss.org"><img src="welcome-content/jboss_community-2277206ce8.png" alt="JBoss and JBoss Community" width="254" height="31" border="0"></a></p>
    </div>
</div>
</body>
</html>
